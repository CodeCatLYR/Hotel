...
import com.amap.map2d.demo.route.BusRouteOverlay;
import com.amap.map2d.demo.route.BusSegmentListAdapter;
...
OnMapClickListener, InfoWindowAdapter, OnInfoWindowClickListener, OnMarkerClickListener {
	...
	private void init() {
		...
		mTitle.setText(getString(R.string.bus_routes_for_details));
		...
		mDesBusRoute.setText(getString(R.string.how_much_take_a_taxi,taxiCost));
