...
import com.tgcyber.hotelmobile._utils.ErrorInfo;
import com.tgcyber.hotelmobile._utils.LogCat;
import com.tgcyber.hotelmobile._utils.TTSController;
...
public class GPSNaviActivity extends Activity  implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        LogCat.i("GPSNaviActivity","onCreate");
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
       double bLng = getIntent().getDoubleExtra("bLng",0);
        double bLat = getIntent().getDoubleExtra("bLat",0);
        double eLng = getIntent().getDoubleExtra("eLng",0);
        double eLat = getIntent().getDoubleExtra("eLat",0);
        type= getIntent().getStringExtra("type");
        if(bLat==0||bLng==0||eLng==0||eLat==0)
        {
            LogCat.i("GPSNaviActivity","onCreate null bLat="+bLat+ " blng="+bLng+" eLat="+eLat);
            finish();
        }
        mEndLatlng = new NaviLatLng(eLat,eLng);
        mStartLatlng = new NaviLatLng(bLat,bLng);
        //实例化语音引擎
      ...
      mAMapNavi.addAMapNaviListener(mTtsManager);
        ...
        LogCat.i("GPSNaviActivity","onCreate END");
    }
    ...
    public void onCalculateRouteSuccess() {
        ...
        protected void onResume() {
            LogCat.i("GPSNaviActivity","onResume END");
            super.onResume();
