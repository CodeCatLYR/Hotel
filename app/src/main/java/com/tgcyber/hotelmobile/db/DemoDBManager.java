package com.tgcyber.hotelmobile.db;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(HotelApplication.getInstance().getApplicationContext());
    }
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(HXConstant.NEW_FRIENDS_USERNAME) || username.equals(HXConstant.GROUP_USERNAME)
                        || username.equals(HXConstant.CHAT_ROOM)|| username.equals(HXConstant.CHAT_ROBOT)) {
