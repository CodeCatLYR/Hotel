package com.tgcyber.hotelmobile.audio;
...
public class AudioManager {
    ...
    private AudioManager(String dir) {
        mDir = dir;
        LogCat.i("AudioManager", "mDir"+mDir );
    }
    ...
    public void prepareAudio() {
        try {
            LogCat.i("AudioManager", "prepareAudio" );
            isPrepare = false;
    ...
    public int getVoiceLevel(int maxlevel) {
        if (isPrepare) {
            try {
                LogCat.i("AudioManager", "getVoiceLevel:"+maxlevel );
     ...
     */
    public void cancel() {
        LogCat.i("AudioManager", "cancel" );
        release();
        if (mCurrentFilePath != null) {
            LogCat.i("AudioManager", "delete" +mCurrentFilePath);
            //取消录音后删除对应文件
