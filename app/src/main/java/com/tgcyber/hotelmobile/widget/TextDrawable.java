...
public class TextDrawable extends Drawable {
    ...
    private static final int[] appearanceAttributes = {
            android.R.attr.textSize, android.R.attr.typeface,
    ...
    public TextDrawable(Context context) {
        ...
        TypedArray ap = null;
        if (appearanceId != -1) {
            ap = context.obtainStyledAttributes(appearanceId,
     ...
     *
     * @param colorStateList ColorStateList of text colors, such as inflated from an
     *                       R.color resource
     */
    ...
    private void measureContent() {
        ...
        if (mTextPath != null) {
            ...
            // Measure text bounds
            double desired = Math.ceil(Layout
                    .getDesiredWidth(mText, mTextPaint));
            mTextLayout = new StaticLayout(mText, mTextPaint, (int) desired,
                    mTextAlignment, 1.0f, 0.0f, false);
            mTextBounds.set(0, 0, mTextLayout.getWidth(),
