...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    // Set the resistence to not let the target go so easily.
    private float mResistance = 0.4f;
     ...
     */
    public void setColorSchemeRes(int colorRes1, int colorRes2, int colorRes3,
                                  int colorRes4) {
        ensureTarget();
    ...
    /**
     * Set the four colors used in the progress animation (Color code instead of
     * resource id)
     *
     * @param color1 Color int.
     * @param color2 Color int.
     * @param color3 Color int.
     * @param color4 Color int.
     */
    public void setColorSchemeColor(int color1, int color2, int color3,
                                    int color4) {
        ensureTarget();
        mProgressBar.setColorScheme(color1, color2, color3, color4);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mDownEvent != null && !mReturningToStart && enabledRefresh) {
