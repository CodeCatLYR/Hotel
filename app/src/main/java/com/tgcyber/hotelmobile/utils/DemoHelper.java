...
import com.tgcyber.hotelmobile.BuildConfig;
import com.tgcyber.hotelmobile.R;
import com.tgcyber.hotelmobile._activity.ChatActivity;
import com.tgcyber.hotelmobile._activity.MainActivity;
import com.tgcyber.hotelmobile.bean.DemoModel;
import com.tgcyber.hotelmobile.bean.InviteMessage;
import com.tgcyber.hotelmobile.bean.RobotUser;
import com.tgcyber.hotelmobile.constants.HXConstant;
import com.tgcyber.hotelmobile.db.DemoDBManager;
import com.tgcyber.hotelmobile.db.InviteMessgeDao;
import com.tgcyber.hotelmobile.db.UserDao;
...
public class DemoHelper {
	...
	private String username = "13580130327";
...
//        });
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                String nickname = message.getStringAttribute(EaseConstant.NICK_NAME, "");
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
                ...
                if (error == EMError.USER_REMOVED) {
                    onUserException(HXConstant.ACCOUNT_REMOVED);
                } else if (error == EMError.USER_LOGIN_ANOTHER_DEVICE) {
                    onUserException(HXConstant.ACCOUNT_CONFLICT);
                } else if (error == EMError.SERVER_SERVICE_RESTRICTED) {
                    onUserException(HXConstant.ACCOUNT_FORBIDDEN);
                }
            }
