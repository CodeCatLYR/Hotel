...
public class Constants {
	...
	public static final LatLng GUANGXHOU = new LatLng(23.16667,113.23333);// 广州市经纬度 广州经纬度:(113.23333,   23.16667)
	//澳门经纬度:(113.50000,   22.20000)
	public static final LatLng AOMEN = new LatLng(22.160837,113.563293);//22.20000,113.50000);// 澳门经纬度
}
